...
export default function NotFound() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen text-center bg-white px-5">
      ...
      <h2 className="text-3xl md:text-4xl font-bold mb-6 text-black">Page Introuvable</h2>

      <p className="mb-10 text-lg md:text-xl text-gray-600 max-w-md mx-auto">
        {/* Correction : n'existe -> n&apos;existe et l'accueil -> l&apos;accueil */}
        Oups ! Il semblerait que vous vous soyez perdu. Cette page n&apos;existe pas ou a été
        déplacée.
      </p>
