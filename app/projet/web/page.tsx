...
export default function ProjetYdays() {
  ...
  const projects = projetData.projectPage.web.projects; // Liste des projets
  ...
  return (
    <div className="flex h-full bg-gradient-to-r from-green-blue to-blue-darkBlue">
      {/* Composant Nav */}
      ...
      <div className="flex-1 flex flex-col items-center mt-10 mx-auto px-5 lg:pl-56 w-full lg:w-3/4 lg:max-w-9xl">
        <div className="flex flex-col items-center justify-center">
          <h1 className="text-3xl mb-20">Web</h1>
          {/* Liste des projets */}
